...
public class HapticPlugin : MonoBehaviour
{
    ...
    public void ActivateVibration(Vector3 GDir, float GMag, int Frequency, float time)
    {
        setVibrationValues(DeviceIdentifier, Vector3ToDoubleArray(GDir), GMag, Frequency, 10.0);
    }
